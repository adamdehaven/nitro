...
Enable `/_scalar`, `/_kong`, `/_swagger`, and `/_openapi.json` endpoints.
...
If you like to customize the Kong Spec Renderer integration, you can [pass a configuration object](https://github.com/Kong/spec-renderer) like this:
